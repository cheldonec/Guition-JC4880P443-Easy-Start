...
#define LCD_COLOR_PIXEL_FORMAT    LCD_COLOR_PIXEL_FORMAT_RGB565
...
#define LCD_TOUCH_RST       (GPIO_NUM_NC) //GPIO_NUM_22
#define LCD_TOUCH_INT       (GPIO_NUM_NC) //GPIO_NUM_21

#define LCD_BACKLIGHT   (PIN_NUM_BK_LIGHT)
#define LCD_RST         (PIN_NUM_LCD_RST)

#define LCD_MIPI_DSI_LANE_NUM          (2)              // 2 data lanes
#define LCD_MIPI_DSI_LANE_BITRATE_MBPS (1000)           // 1Gbps
#define I2C_CLK_SPEED_HZ               (400000)
#define I2C_PORT_NUM                   (0)              // ← ИСПРАВЛЕНО: I2C_NUM_0 (тот же, что и для аудио!)
